  ...
  return (
    <section id="about" className="sm:my-8 font-poppins">
        <div className="flex justify-center items-center mb-8 pt-8">
            <h1 className=" text-4xl sm:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-purple-700 drop-shadow-sm">Nice to meet you!</h1>
        </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 mb-12 sm:mb-20">
        <div className=" mr-4">
        ...
        <div className="py-4 mx-8 mt-8 sm:pr-8 sm:mr-8 font-semibold text-gray-600 tracking-wide leading-relaxed">
            <p className="sm:text-center pb-8">I'm <span className="text-lg text-blue-600 ">Harrison Payne</span>.</p>
          <p>
